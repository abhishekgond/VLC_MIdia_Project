...
const volueUpHandler = () => {
  ...
  const persentage = Math.floor(volumeUP * 100) + "%"; //create volume function panding
  shomesage(persentage);
...
const volueDownHandler = () => {
  ...
  const persentage1 = Math.floor(volumeDown * 100) + "%";
  shomesage(persentage1); //create volume function panding
